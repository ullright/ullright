...
CREATE TABLE ull_parent_entity (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), first_name VARCHAR(64), last_name VARCHAR(64), display_name VARCHAR(64), username VARCHAR(64) UNIQUE, email VARCHAR(64), password VARCHAR(40), created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE ull_entity (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), first_name VARCHAR(64), last_name VARCHAR(64), display_name VARCHAR(64), username VARCHAR(64) UNIQUE, email VARCHAR(64), password VARCHAR(40), type VARCHAR(255), created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, PRIMARY KEY(id)) ENGINE = INNODB;
