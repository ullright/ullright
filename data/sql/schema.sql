...
CREATE TABLE ull_wiki_version (id BIGINT, namespace VARCHAR(32), subject VARCHAR(255) NOT NULL, body LONGTEXT, read_counter BIGINT, edit_counter BIGINT, duplicate_tags_for_search LONGTEXT, created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, deleted TINYINT(1) DEFAULT '0' NOT NULL, version BIGINT, PRIMARY KEY(id, version)) ENGINE = INNODB;
CREATE TABLE ull_wiki (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), subject VARCHAR(255) NOT NULL, body LONGTEXT, read_counter BIGINT, edit_counter BIGINT, duplicate_tags_for_search LONGTEXT, created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, deleted TINYINT(1) DEFAULT '0' NOT NULL, version BIGINT, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE ull_flow_step_action (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), ull_flow_step_id BIGINT, ull_flow_action_id BIGINT, options VARCHAR(255), sequence BIGINT, created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_flow_step_id_idx (ull_flow_step_id), INDEX ull_flow_action_id_idx (ull_flow_action_id), PRIMARY KEY(id)) ENGINE = INNODB;
