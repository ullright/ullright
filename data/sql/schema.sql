...
CREATE TABLE ull_parent_entity (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', first_name VARCHAR(64), last_name VARCHAR(64), display_name VARCHAR(64), username VARCHAR(64) UNIQUE, email VARCHAR(64), password VARCHAR(40), user_type BIGINT, created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE ull_entity (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', first_name VARCHAR(64), last_name VARCHAR(64), display_name VARCHAR(64), username VARCHAR(64) UNIQUE, email VARCHAR(64), password VARCHAR(40), user_type BIGINT, type VARCHAR(255), created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE ull_entity_group (namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', ull_entity_id BIGINT, ull_group_id BIGINT, created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), PRIMARY KEY(ull_entity_id, ull_group_id)) ENGINE = INNODB;
CREATE TABLE ull_group_permission (namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', ull_group_id BIGINT, ull_permission_id BIGINT, created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), PRIMARY KEY(ull_group_id, ull_permission_id)) ENGINE = INNODB;
CREATE TABLE ull_permission (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', slug VARCHAR(64), created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE ull_wiki_version (id BIGINT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', docid BIGINT NOT NULL, culture VARCHAR(7), body LONGTEXT, subject VARCHAR(255) NOT NULL, changelog_comment VARCHAR(255), read_counter BIGINT, edit_counter BIGINT, duplicate_tags_for_search LONGTEXT, locked_by_user_id BIGINT, locked_at DATETIME, created_at DATETIME, updated_at DATETIME, version BIGINT, PRIMARY KEY(id, version)) ENGINE = INNODB;
CREATE TABLE ull_wiki (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', docid BIGINT NOT NULL, culture VARCHAR(7), body LONGTEXT, subject VARCHAR(255) NOT NULL, changelog_comment VARCHAR(255), read_counter BIGINT, edit_counter BIGINT, duplicate_tags_for_search LONGTEXT, locked_by_user_id BIGINT, locked_at DATETIME, created_at DATETIME, updated_at DATETIME, version BIGINT, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX locked_by_user_id_idx (locked_by_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE ull_flow_column_config (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', ull_flow_app_id BIGINT NOT NULL, slug VARCHAR(32) NOT NULL, sequence BIGINT, ull_column_type_id BIGINT, options LONGTEXT, enabled TINYINT(1) DEFAULT '1', show_in_list TINYINT(1) DEFAULT '1', mandatory TINYINT(1) DEFAULT '0', is_title TINYINT(1) DEFAULT '0', default_value VARCHAR(255), created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_flow_app_id_idx (ull_flow_app_id), INDEX ull_column_type_id_idx (ull_column_type_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE ull_flow_app_permission (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', ull_flow_app_id BIGINT NOT NULL, ull_permission_id BIGINT NOT NULL, created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_permission_id_idx (ull_permission_id), INDEX ull_flow_app_id_idx (ull_flow_app_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE ull_flow_memory (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', ull_flow_doc_id BIGINT NOT NULL, ull_flow_step_id BIGINT, ull_flow_action_id BIGINT, assigned_to_ull_entity_id BIGINT NOT NULL, comment VARCHAR(255), creator_ull_entity_id BIGINT NOT NULL, created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_flow_doc_id_idx (ull_flow_doc_id), INDEX assigned_to_ull_entity_id_idx (assigned_to_ull_entity_id), INDEX creator_ull_entity_id_idx (creator_ull_entity_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE ull_flow_doc (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), creator_user_id BIGINT DEFAULT '1', updator_user_id BIGINT DEFAULT '1', ull_flow_app_id BIGINT NOT NULL, title VARCHAR(255), ull_flow_action_id BIGINT, assigned_to_ull_entity_id BIGINT NOT NULL, assigned_to_ull_flow_step_id BIGINT, created_at DATETIME, updated_at DATETIME, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_flow_app_id_idx (ull_flow_app_id), INDEX assigned_to_ull_entity_id_idx (assigned_to_ull_entity_id), PRIMARY KEY(id)) ENGINE = INNODB;
