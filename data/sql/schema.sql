...
CREATE TABLE ull_ventory_item_memory (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), ull_ventory_item_id BIGINT NOT NULL, transfer_at DATETIME NOT NULL, source_ull_user_id BIGINT NOT NULL, target_ull_user_id BIGINT NOT NULL, comment TEXT, created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_ventory_item_id_idx (ull_ventory_item_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE ull_ventory_item (id BIGINT AUTO_INCREMENT, namespace VARCHAR(32), inventory_number VARCHAR(128) NOT NULL UNIQUE, serial_number VARCHAR(128), comment TEXT, ull_ventory_item_model_id BIGINT NOT NULL, ull_user_id BIGINT NOT NULL, created_at DATETIME, updated_at DATETIME, creator_user_id BIGINT, updator_user_id BIGINT, INDEX creator_user_id_idx (creator_user_id), INDEX updator_user_id_idx (updator_user_id), INDEX ull_ventory_item_model_id_idx (ull_ventory_item_model_id), INDEX ull_user_id_idx (ull_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
