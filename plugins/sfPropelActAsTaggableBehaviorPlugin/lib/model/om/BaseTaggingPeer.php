...
abstract class BaseTaggingPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ID', 'TagId', 'TaggableModel', 'TaggableId', ),
		BasePeer::TYPE_COLNAME => array (TaggingPeer::ID, TaggingPeer::TAG_ID, TaggingPeer::TAGGABLE_MODEL, TaggingPeer::TAGGABLE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'tag_id', 'taggable_model', 'taggable_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ID' => 0, 'TagId' => 1, 'TaggableModel' => 2, 'TaggableId' => 3, ),
		BasePeer::TYPE_COLNAME => array (TaggingPeer::ID => 0, TaggingPeer::TAG_ID => 1, TaggingPeer::TAGGABLE_MODEL => 2, TaggingPeer::TAGGABLE_ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'tag_id' => 1, 'taggable_model' => 2, 'taggable_id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	 ...
	 * @param      string $column The column name for current table. (i.e. TaggingPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	/**
	 * Selects a collection of Tagging objects pre-filled with their Tag objects.
	 *
	 * @return     array Array of Tagging objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinTag(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getTag(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addTagging($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initTaggings();
				$obj2->addTagging($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	/**
	 * Selects a collection of Tagging objects pre-filled with all related objects.
	 *
	 * @return     array Array of Tagging objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Method perform an INSERT on the database, given a Tagging or Criteria object.
	 *
	 * @param      mixed $values Criteria or Tagging object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
    ...
    foreach (sfMixer::getCallables('BaseTaggingPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Tagging object
		}

		$criteria->remove(TaggingPeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a Tagging or Criteria object.
	 *
	 * @param      mixed $values Criteria or Tagging object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a Tagging or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Tagging object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof Tagging) {
	...
	/**
	 * Validates all modified columns of given Tagging object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Tagging $obj The object to validate.
