...
$createValues = array(
  'ull_flow_step_id' => array(Doctrine::getTable('UllFlowStep')->findOneBySlug('todo_creator')->id, 'Creator'), 
...
$editValues = array(
  'ull_flow_step_id' => array(Doctrine::getTable('UllFlowStep')->findOneBySlug('trouble_ticket_closed')->id, 'Closed'), 
