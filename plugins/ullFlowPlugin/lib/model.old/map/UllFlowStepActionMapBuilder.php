...
/**
 * This class adds structure of 'ull_flow_step_action' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class UllFlowStepActionMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.ullFlowPlugin.lib.model.map.UllFlowStepActionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ull_flow_step_action');
		$tMap->setPhpName('UllFlowStepAction');
