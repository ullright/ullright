...
class ullCmsPageGenerator extends ullTableToolGenerator
{
  protected
    $contentType
  ;
  ...
  {
    $this->columnsConfig = ullCmsPageColumnConfigCollection::build($this->contentType, $this->defaultAccess, $this->requestAction);
