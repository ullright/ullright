...
Eine CMS-Seite wird zu einem Sidebar-Block in dem man bei "`Übergeordneten Menüeintrag"' "`Sidebar-Blöcke"' (o.Ä.) auswählt. (Siehe Kapitel \vref{sec:edit} für Details zum Bearbeiten von Seiten)
