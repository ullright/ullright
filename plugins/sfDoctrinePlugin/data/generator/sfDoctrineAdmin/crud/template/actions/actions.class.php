 ...
 * @version    SVN: $Id: actions.class.php 10756 2008-08-08 19:09:25Z Jonathan.Wage $
 */
class <?php echo $this->getGeneratedModuleName() ?>Actions extends sfActions
{
  ...
  {
  	$this-><?php echo $this->getPluralName() ?> = Doctrine::getTable('<?php echo $this->getClassName() ?>')->findAll();
  }

  public function executeShow ()
  {
    $this-><?php echo $this->getSingularName() ?> = Doctrine::getTable('<?php echo $this->getClassName() ?>')->find(<?php echo $this->getRetrieveByPkParamsForAction('') ?>);    
  ...
  public function executeUpdate ()
  {
    ...
    {
      $<?php echo $this->getSingularName() ?> = Doctrine::getTable('<?php echo $this->getClassName() ?>')->find(<?php echo $this->getRetrieveByPkParamsForAction('') ?>);
