 ...
 * @version    SVN: $Id: actions.class.php 11457 2008-09-11 21:03:53Z Jonathan.Wage $
 */
...
<?php if ($peerMethod = $this->getParameterValue('list.peer_method')): ?>    
    $q = Doctrine::getTable('<?php echo $this->getClassName() ?>')-><?php echo $peerMethod ?>();
...
<?php endif; ?>
  ...
  {
    $this-><?php echo $this->getSingularName() ?> = Doctrine::getTable('<?php echo $this->getClassName() ?>')->find(<?php echo $this->getRetrieveByPkParamsForAction(40) ?>);
...
if (in_array($input_type, array('doctrine_admin_double_list', 'doctrine_admin_check_list', 'doctrine_admin_select_list'))): ?>
      ...
      $<?php echo $name?>Table = Doctrine::getTable('<?php echo $this->getClassName() ?>')->getRelation('<?php echo $name ?>')->getTable();
 
      $associationName = Doctrine::getTable('<?php echo $this->getClassName() ?>')->getRelation('<?php echo $name ?>')->getAssociationTable()->getOption('name');
...
<?php endforeach; ?>
  ...
  protected function get<?php echo $this->getClassName() ?>OrCreate (<?php echo $this->getMethodParamsForGetOrCreate() ?>)
  {
    ...
    {
      $<?php echo $this->getSingularName() ?> = Doctrine::getTable('<?php echo $this->getClassName() ?>')->find(array(<?php echo $this->getRetrieveByPkParamsForGetOrCreate() ?>));
