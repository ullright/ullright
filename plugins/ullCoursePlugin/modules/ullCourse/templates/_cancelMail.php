...
<?php echo __('we are sorry to inform you that course "%course%" has been canceled', array('%course%' => ullCoreTools::esc_decode($booking->UllCourse->name)), 'ullCourseMessages') ?>.
