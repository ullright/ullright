...
<h1><?php echo __('Send cancelation email for course "%course%"', array('%course%' => $course->name), 'ullCourseMessages') ?></h1>

<?php include_partial('ullTableTool/globalError', array('form' => $form)) ?>

<?php echo form_tag('ullCourse/cancel?slug=' . $course['slug'], array('id' => 'ull_course_cancel_form')) ?>
