 ...
 * @return unknown_type the url to Google
 */
function ull_url_for_barcode($content, $width = 200, $height = 70)
{
  return 'http://www.barcodesinc.com/generator/image.php?code=' . $content . '&style=198&type=C39&width=' . $width . '&height=' . $height . '&xres=1&font=100';
}
