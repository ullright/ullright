 ...
 *
 * @link http://pchart.sourceforge.net/screenshots.php?ID=9
 */

// Standard inclusions
include('mtChart/mtChart.php');

// Dataset definition
$Test = new mtChart(700,230);
$Test->addPoint(array(0,70,70,0,0,70,70,0,0,70),"Serie1");
$Test->addPoint(array(0.5,2,4.5,8,12.5,18,24.5,32,40.5,50),"Serie2");
...
// Set labels
$Test->setFontProperties('DejaVuSansCondensed',8);
$Test->setLabel("Serie1","2","Daily incomes",221,230,174);
$Test->setLabel("Serie2","6","Production break",239,233,195);
