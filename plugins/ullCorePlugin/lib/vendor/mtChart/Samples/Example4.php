<?php
/**
 * Example4 : Showing how to draw an area
 *
 * Taken from the pChart example library
 *
 * @link http://pchart.sourceforge.net/screenshots.php?ID=4
 */
...
$Test->removeSerieName("Serie1");
$Test->removeSerieName("Serie3");
...
// Draw the area
$Test->drawArea("Serie1","Serie3",239,238,227,50);
...
// Finish the graph
$Test->setFontProperties('DejaVuSansCondensed',8);
$Test->drawLegend(65,35,250,250,250);
