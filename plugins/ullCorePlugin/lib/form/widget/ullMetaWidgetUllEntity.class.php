...
//  {
//    // generic query -> get all entities
//    $q = new Doctrine_Query;
//    $q
//      ->select('u.id, u.display_name')
//      ->from('UllEntity u, u.Translation')
//      ->orderBy('u.last_name, u.first_name')
//    ;
//
//    //filter users by group
//    if ($groupName = $this->columnConfig->getWidgetOption('group'))
//    {
...
//    $this->columnConfig->setWidgetOption('alias', 'u');
//    
