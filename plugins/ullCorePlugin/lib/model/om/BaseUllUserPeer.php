...
abstract class BaseUllUserPeer {
	...
	{
		include_once 'plugins/ullCorePlugin/lib/model/map/UllUserMapBuilder.php';
    ...
    foreach (sfMixer::getCallables('BaseUllUserPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
...
if (Propel::isInit()) {
	...
	require_once 'plugins/ullCorePlugin/lib/model/map/UllUserMapBuilder.php';
