...
/**
 * This class adds structure of 'ull_table_info' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class UllTableInfoMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.ullCorePlugin.lib.model.map.UllTableInfoMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ull_table_info');
		$tMap->setPhpName('UllTableInfo');
		...
		$tMap->addColumn('SORT_FIELDS', 'SortFields', 'string', CreoleTypes::VARCHAR, false, 256);

		$tMap->addColumn('SEARCH_FIELDS', 'SearchFields', 'string', CreoleTypes::VARCHAR, false, 256);
