...
/**
 * This class adds structure of 'ull_select' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class UllSelectMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.ullCorePlugin.lib.model.map.UllSelectMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ull_select');
		$tMap->setPhpName('UllSelect');
