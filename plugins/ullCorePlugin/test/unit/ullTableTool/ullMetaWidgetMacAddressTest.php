...
class myTestCase extends lime_test
{
  public function getColumnConfig()
  {
    ...
    $columnConfig->setMetaWidgetClassName('ullMetaWidgetMacAddress');
...
$t->diag('for read access:');
  $widget = new ullMetaWidgetMacAddress($columnConfig, $form);
  $t->isa_ok($widget, 'ullMetaWidgetMacAddress', '__construct() returns the correct object');
...
$t->diag('for write access:');
  ...
  $t->isa_ok($form->getValidatorSchema()->offsetGet('my_field'), 'ullValidatorMacAddress', 'returns the correct validator for write access');
