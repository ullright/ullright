...
$b
  ...
  ->setField('fields[scheduled_update_date]', '08/15/3000') //should be 'future' enough :)
  ->click('Save')
  ->isRedirected()
  ->followRedirect()
  ->isStatusCode(200)
...
$b
  ...
  ->setField('fields[scheduled_update_date]', '08/15/2999')
  ->click('Save')
  ->isRedirected()
  ->followRedirect()
  ->isStatusCode(200)
...
$b
  ...
  ->checkResponseElement('div#edit_future_versions', '/08-15-3000/')
