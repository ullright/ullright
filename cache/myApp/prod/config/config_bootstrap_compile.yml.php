...
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "magic_quotes_gpc" key is better set to "false" (current value is "\'1\'" - php.ini location: "/etc/php5/apache2/php.ini")');
}
