...
class BaseUllVentoryItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ull_location_id'           => new sfWidgetFormDoctrineChoice(array('model' => 'UllLocation', 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'ull_location_id'           => new sfValidatorDoctrineChoice(array('model' => 'UllLocation')),
