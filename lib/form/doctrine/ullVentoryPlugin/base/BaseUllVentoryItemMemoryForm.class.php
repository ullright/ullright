...
class BaseUllVentoryItemMemoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'source_ull_entity_id' => new sfWidgetFormDoctrineChoice(array('model' => 'UllEntity', 'add_empty' => false)),
      'target_ull_entity_id' => new sfWidgetFormDoctrineChoice(array('model' => 'UllEntity', 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'source_ull_entity_id' => new sfValidatorDoctrineChoice(array('model' => 'UllEntity')),
      'target_ull_entity_id' => new sfValidatorDoctrineChoice(array('model' => 'UllEntity')),
