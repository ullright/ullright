...
/**
 * UllVentoryOriginDummyUserVersion form base class.
 *
 * @package    form
 * @subpackage ull_ventory_origin_dummy_user_version
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllVentoryOriginDummyUserVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'last_name_first'                    => new sfWidgetFormInput(),
      ...
      'personnel_number'                   => new sfWidgetFormInput(),
      ...
      'is_show_in_phonebook'               => new sfWidgetFormInputCheckbox(),
      'phone_extension'                    => new sfWidgetFormInput(),
      'alternative_phone_extension'        => new sfWidgetFormInput(),
      ...
      'is_photo_public'                    => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      'id'                                 => new sfValidatorDoctrineChoice(array('model' => 'UllVentoryOriginDummyUserVersion', 'column' => 'id', 'required' => false)),
      ...
      'last_name_first'                    => new sfValidatorString(array('max_length' => 129, 'required' => false)),
      ...
      'personnel_number'                   => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      ...
      'cost_center'                        => new sfValidatorString(array('max_length' => 64, 'required' => false)),
      ...
      'is_show_in_phonebook'               => new sfValidatorBoolean(array('required' => false)),
      'phone_extension'                    => new sfValidatorInteger(array('required' => false)),
      'alternative_phone_extension'        => new sfValidatorInteger(array('required' => false)),
      ...
      'is_photo_public'                    => new sfValidatorBoolean(array('required' => false)),
      ...
      'version'                            => new sfValidatorDoctrineChoice(array('model' => 'UllVentoryOriginDummyUserVersion', 'column' => 'version', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ull_ventory_origin_dummy_user_version[%s]');
  ...
  {
    return 'UllVentoryOriginDummyUserVersion';
  }
