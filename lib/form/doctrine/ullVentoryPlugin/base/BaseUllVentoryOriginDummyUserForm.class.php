...
/**
 * UllVentoryOriginDummyUser form base class.
 *
 * @package    form
 * @subpackage ull_ventory_origin_dummy_user
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllVentoryOriginDummyUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                                 => new sfValidatorDoctrineChoice(array('model' => 'UllVentoryOriginDummyUser', 'column' => 'id', 'required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'UllVentoryOriginDummyUser', 'column' => array('username')))
    );

    $this->widgetSchema->setNameFormat('ull_ventory_origin_dummy_user[%s]');
