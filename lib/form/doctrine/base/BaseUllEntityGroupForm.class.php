...
class BaseUllEntityGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'entity_id'       => new sfValidatorDoctrineChoice(array('model' => 'UllEntityGroup', 'column' => 'entity_id', 'required' => false)),
      'group_id'        => new sfValidatorDoctrineChoice(array('model' => 'UllEntityGroup', 'column' => 'group_id', 'required' => false)),
