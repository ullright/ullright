...
class BaseUllFlowDocForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ull_flow_action_id'           => new sfWidgetFormInput(),
      'assigned_to_ull_entitiy_id'   => new sfWidgetFormDoctrineSelect(array('model' => 'UllEntity', 'add_empty' => false)),
      'assigned_to_ull_flow_step_id' => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      ...
      'ull_flow_action_id'           => new sfValidatorInteger(array('required' => false)),
      'assigned_to_ull_entitiy_id'   => new sfValidatorDoctrineChoice(array('model' => 'UllEntity')),
      'assigned_to_ull_flow_step_id' => new sfValidatorInteger(array('required' => false)),
