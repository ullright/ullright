...
/**
 * UllEntityVersion form base class.
 *
 * @package    form
 * @subpackage ull_entity_version
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllEntityVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                                 => new sfValidatorDoctrineChoice(array('model' => 'UllEntityVersion', 'column' => 'id', 'required' => false)),
      ...
      'version'                            => new sfValidatorDoctrineChoice(array('model' => 'UllEntityVersion', 'column' => 'version', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ull_entity_version[%s]');
