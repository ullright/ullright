...
class BaseUllUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ull_employment_type_id'             => new sfWidgetFormDoctrineSelect(array('model' => 'UllEmploymentType', 'add_empty' => true)),
      'ull_job_title_id'                   => new sfWidgetFormDoctrineSelect(array('model' => 'UllJobTitle', 'add_empty' => true)),
      'ull_company_id'                     => new sfWidgetFormDoctrineSelect(array('model' => 'UllCompany', 'add_empty' => true)),
      'ull_department_id'                  => new sfWidgetFormDoctrineSelect(array('model' => 'UllDepartment', 'add_empty' => true)),
      'ull_location_id'                    => new sfWidgetFormDoctrineSelect(array('model' => 'UllLocation', 'add_empty' => true)),
      'superior_ull_user_id'               => new sfWidgetFormDoctrineSelect(array('model' => 'UllUser', 'add_empty' => true)),
      ...
      'ull_user_status_id'                 => new sfWidgetFormDoctrineSelect(array('model' => 'UllUserStatus', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'ull_user_status_id'                 => new sfValidatorDoctrineChoice(array('model' => 'UllUserStatus', 'required' => false)),
