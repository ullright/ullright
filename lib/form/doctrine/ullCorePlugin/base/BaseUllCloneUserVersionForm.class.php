...
/**
 * UllCloneUserVersion form base class.
 *
 * @package    form
 * @subpackage ull_clone_user_version
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllCloneUserVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                                 => new sfValidatorDoctrineChoice(array('model' => 'UllCloneUserVersion', 'column' => 'id', 'required' => false)),
      ...
      'version'                            => new sfValidatorDoctrineChoice(array('model' => 'UllCloneUserVersion', 'column' => 'version', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ull_clone_user_version[%s]');
