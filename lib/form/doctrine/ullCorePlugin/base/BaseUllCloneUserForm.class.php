...
/**
 * UllCloneUser form base class.
 *
 * @package    form
 * @subpackage ull_clone_user
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllCloneUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                                 => new sfValidatorDoctrineChoice(array('model' => 'UllCloneUser', 'column' => 'id', 'required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'UllCloneUser', 'column' => array('username')))
    );

    $this->widgetSchema->setNameFormat('ull_clone_user[%s]');
