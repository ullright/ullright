...
/**
 * UllDepartment form base class.
 *
 * @package    form
 * @subpackage ull_department
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllDepartmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'              => new sfValidatorDoctrineChoice(array('model' => 'UllDepartment', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ull_department[%s]');
