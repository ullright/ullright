...
/**
 * UllUserVersion form base class.
 *
 * @package    form
 * @subpackage ull_user_version
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseUllUserVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'                                 => new sfValidatorDoctrineChoice(array('model' => 'UllUserVersion', 'column' => 'id', 'required' => false)),
      ...
      'version'                            => new sfValidatorDoctrineChoice(array('model' => 'UllUserVersion', 'column' => 'version', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ull_user_version[%s]');
