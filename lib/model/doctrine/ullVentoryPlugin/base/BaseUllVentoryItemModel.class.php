...
abstract class BaseUllVentoryItemModel extends UllRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ull_ventory_item_manufacturer_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
    ...
    {
        parent::setUp();
    $this->hasOne('UllVentoryItemManufacturer', array(
             'local' => 'ull_ventory_item_manufacturer_id',
             'foreign' => 'id',
             'onDelete' => 'CASCADE'));
        ...
        $this->hasMany('UllVentoryItem', array(
             'local' => 'id',
