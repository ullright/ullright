...
abstract class BaseUllVentoryItemMemory extends UllRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('transfer_at', 'timestamp', null, array(
             'type' => 'timestamp',
             'notnull' => true,
             ));
        $this->hasColumn('source_ull_entity_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
        $this->hasColumn('target_ull_entity_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
    ...
    $this->hasOne('UllVentoryItem', array(
        ...
        $this->hasOne('UllEntity as SourceUllEntity', array(
             'local' => 'source_ull_entity_id',
             'foreign' => 'id'));

        $this->hasOne('UllEntity as TargetUllEntity', array(
