...
abstract class BaseUllLocation extends UllRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('post_code', 'string', 10, array(
             'type' => 'string',
             'length' => '10',
             ));
        $this->hasColumn('phone_base_no', 'string', 20, array(
             'type' => 'string',
             'length' => '20',
             ));
        $this->hasColumn('phone_default_extension', 'integer', null, array(
             'type' => 'integer',
             ));
        $this->hasColumn('fax_base_no', 'string', 20, array(
             'type' => 'string',
             'length' => '20',
             ));
        $this->hasColumn('fax_default_extension', 'integer', null, array(
             'type' => 'integer',
             ));
    }
