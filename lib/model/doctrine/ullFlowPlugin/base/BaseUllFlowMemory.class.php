...
abstract class BaseUllFlowMemory extends UllRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('creator_ull_entity_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
    }
    ...
    $this->hasOne('UllFlowDoc', array(
        ...
        $this->hasOne('UllEntity as AssignedToUllEntity', array(
             'local' => 'assigned_to_ull_entity_id',
             'foreign' => 'id'));

        $this->hasOne('UllEntity as CreatorUllEntity', array(
