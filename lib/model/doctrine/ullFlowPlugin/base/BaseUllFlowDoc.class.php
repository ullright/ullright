...
abstract class BaseUllFlowDoc extends UllRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('assigned_to_ull_entity_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
        $this->hasColumn('assigned_to_ull_flow_step_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
        ...
        $this->hasColumn('dirty', 'integer', null, array(
             'type' => 'integer',
             ));
    }
    ...
    $this->hasOne('UllFlowApp', array(
        ...
        $this->hasMany('UllFlowValue as UllFlowValues', array(
             'local' => 'id',
