...
/**
 * UllWikiAccessLevel filter form base class.
 *
 * @package    filters
 * @subpackage UllWikiAccessLevel *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllWikiAccessLevelFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_wiki_access_level_filters[%s]');
