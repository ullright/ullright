...
class BaseUllWikiVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ull_wiki_access_level_id'  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'ull_wiki_access_level_id'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'ull_wiki_access_level_id'  => 'Number',
      'created_at'                => 'Date',
      'updated_at'                => 'Date',
