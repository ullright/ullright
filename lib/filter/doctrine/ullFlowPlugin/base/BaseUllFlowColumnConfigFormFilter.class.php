...
class BaseUllFlowColumnConfigFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_priority'        => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'is_tagging'         => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'is_priority'        => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'is_tagging'         => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
