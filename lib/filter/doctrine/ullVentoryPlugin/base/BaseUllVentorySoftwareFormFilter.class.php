...
/**
 * UllVentorySoftware filter form base class.
 *
 * @package    filters
 * @subpackage UllVentorySoftware *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllVentorySoftwareFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_ventory_software_filters[%s]');
