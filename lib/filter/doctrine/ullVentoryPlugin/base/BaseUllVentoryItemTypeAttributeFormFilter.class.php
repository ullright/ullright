...
class BaseUllVentoryItemTypeAttributeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_presetable'                 => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'is_presetable'                 => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
