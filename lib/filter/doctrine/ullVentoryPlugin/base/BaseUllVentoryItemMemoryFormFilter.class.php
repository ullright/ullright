...
class BaseUllVentoryItemMemoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'source_ull_entity_id' => new sfWidgetFormDoctrineChoice(array('model' => 'UllEntity', 'add_empty' => true)),
      'target_ull_entity_id' => new sfWidgetFormDoctrineChoice(array('model' => 'UllEntity', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'source_ull_entity_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'UllEntity', 'column' => 'id')),
      'target_ull_entity_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'UllEntity', 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'transfer_at'          => 'Date',
      'source_ull_entity_id' => 'ForeignKey',
      'target_ull_entity_id' => 'ForeignKey',
      'comment'              => 'Text',
      'created_at'           => 'Date',
      'updated_at'           => 'Date',
