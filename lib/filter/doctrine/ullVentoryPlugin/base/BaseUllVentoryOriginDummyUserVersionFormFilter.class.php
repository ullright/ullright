...
/**
 * UllVentoryOriginDummyUserVersion filter form base class.
 *
 * @package    filters
 * @subpackage UllVentoryOriginDummyUserVersion *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllVentoryOriginDummyUserVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'last_name_first'                    => new sfWidgetFormFilterInput(),
      ...
      'parent_ull_user_id'                 => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'last_name_first'                    => new sfValidatorPass(array('required' => false)),
      ...
      'parent_ull_user_id'                 => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ull_ventory_origin_dummy_user_version_filters[%s]');
