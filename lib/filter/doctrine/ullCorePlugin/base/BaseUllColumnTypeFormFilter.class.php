...
/**
 * UllColumnType filter form base class.
 *
 * @package    filters
 * @subpackage UllColumnType *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllColumnTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_column_type_filters[%s]');
