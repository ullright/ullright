...
/**
 * UllPrivilege filter form base class.
 *
 * @package    filters
 * @subpackage UllPrivilege *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllPrivilegeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_privilege_filters[%s]');
