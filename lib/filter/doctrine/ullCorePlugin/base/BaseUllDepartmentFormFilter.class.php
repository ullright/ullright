...
/**
 * UllDepartment filter form base class.
 *
 * @package    filters
 * @subpackage UllDepartment *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllDepartmentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_department_filters[%s]');
