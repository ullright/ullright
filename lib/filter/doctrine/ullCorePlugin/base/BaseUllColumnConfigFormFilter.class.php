...
/**
 * UllColumnConfig filter form base class.
 *
 * @package    filters
 * @subpackage UllColumnConfig *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllColumnConfigFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'db_column_name'     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'db_column_name'     => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ull_column_config_filters[%s]');
