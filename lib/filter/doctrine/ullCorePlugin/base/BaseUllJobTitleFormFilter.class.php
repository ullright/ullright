...
/**
 * UllJobTitle filter form base class.
 *
 * @package    filters
 * @subpackage UllJobTitle *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllJobTitleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_job_title_filters[%s]');
