...
/**
 * UllCompany filter form base class.
 *
 * @package    filters
 * @subpackage UllCompany *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllCompanyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_company_filters[%s]');
