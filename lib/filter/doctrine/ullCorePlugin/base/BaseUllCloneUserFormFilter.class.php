...
/**
 * UllCloneUser filter form base class.
 *
 * @package    filters
 * @subpackage UllCloneUser *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllCloneUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_clone_user_filters[%s]');
