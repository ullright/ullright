...
/**
 * UllGroupVersion filter form base class.
 *
 * @package    filters
 * @subpackage UllGroupVersion *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllGroupVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_group_version_filters[%s]');
