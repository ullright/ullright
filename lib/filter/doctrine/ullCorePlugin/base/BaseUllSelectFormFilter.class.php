...
/**
 * UllSelect filter form base class.
 *
 * @package    filters
 * @subpackage UllSelect *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseUllSelectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ull_select_filters[%s]');
